...
const ApiBODYDATAKeys: string[] = ['device_Id', 'earthpitname', 'date', 'description']
...
function modelApiBODYDATAFromJsonContent(name: string, value: any, knownKeys: Record<string, boolean> = {}): Api.BODYDATA {
	...
	const result: Api.BODYDATA = {
		'device_Id': allowUndefined(stringFromJson)(`${name}.device_Id`, value['device_Id']),
		'earthpitname': allowUndefined(stringFromJson)(`${name}.earthpitname`, value['earthpitname']),
		'date': allowUndefined(dateTimeFromJson)(`${name}.date`, value['date']),
...
function modelApiBODYDATAToJsonContent(name: string, value: Api.BODYDATA, knownKeys: Record<string, boolean> = {}): ToJson<Api.BODYDATA> {
	...
	const result: ToJson<Api.BODYDATA> = {
		'device_Id': allowUndefined(stringToJson)(`${name}.device_Id`, value['device_Id']),
		'earthpitname': allowUndefined(stringToJson)(`${name}.earthpitname`, value['earthpitname']),
		'date': allowUndefined(dateTimeToJson)(`${name}.date`, value['date']),
